...
public sealed record EuCommissionRssItem(
    string Title,
    string Link,
...
public sealed class EuCommissionRSSClient
{
    private readonly HttpClient _http;

    public EuCommissionRSSClient(HttpClient http) => _http = http;

    public async Task<IReadOnlyList<EuCommissionRssItem>> FetchAsync(
        Uri feedUri,
        int maxItems,
        CancellationToken ct = default)
    {
        ...
        var items = feed.Items
            ...
            .Select(i =>
            {
                ...
                return new EuCommissionRssItem(
